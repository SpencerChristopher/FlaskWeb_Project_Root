...
class MongoUserRepository(UserRepository):
    ...
    def get_by_id(self, user_id: str) -> Optional[User]:
        try:
            ...
            raise DatabaseConnectionException(
                f"Database error while fetching user by ID: {e}"
            ) from e
    ...
    def get_identity(self, user_id: str) -> Optional[User]:
        try:
            ...
            raise DatabaseConnectionException(
                f"Database error while fetching user identity: {e}"
            ) from e
    ...
    def get_by_username(self, username: str) -> Optional[User]:
        try:
            ...
            raise DatabaseConnectionException(
                f"Database error while fetching user by username: {e}"
            ) from e
    ...
    def save(self, user: User) -> User:
        try:
            ...
            raise DatabaseConnectionException(
                f"Database error while saving user: {e}"
            ) from e
    ...
    def delete(self, user: User) -> None:
        try:
            ...
            raise DatabaseConnectionException(
                f"Database error while deleting user: {e}"
            ) from e
