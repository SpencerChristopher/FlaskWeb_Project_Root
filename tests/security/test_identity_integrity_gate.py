...
class TestIdentityIntegrityGate:
    ...
    def test_profile_update_route_consistency(self, client):
        ...
        ), "Protected route failed to return 401 for unauthenticated PUT"
    ...
    def test_profile_service_requires_user_identity(self, app):
        ...
        with app.app_context():
            ...
            ), "ProfileService.update_profile is missing identity context (Audit Leak)"

    def test_bootstrap_capabilities_alignment(
