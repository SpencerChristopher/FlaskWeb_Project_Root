...
def test_admin_access_after_user_deletion(
    client, app, test_admin_user, login_user_fixture
):
    """
    ...
    expires = datetime.datetime.fromtimestamp(
        decoded_token["exp"], datetime.timezone.utc
    )
...
def test_blacklisted_refresh_token_rejected(
    client, app, test_admin_user, get_refresh_token_fixture
):
    """
...
def test_access_token_invalidated_after_role_change(client, app, login_user_fixture):
    ...
    """
    user = User(
        username="rolechangeuser", email="rolechange@example.com", role="member"
    )
